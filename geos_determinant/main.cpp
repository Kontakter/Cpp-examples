...
void make(double a, double b, double c, double d)
{
    double r = a * d - b * c;    
    cout.setf(std::ios_base::scientific);
    cout.precision(25);
    cout << "Cross product = " << r << endl;
    cout << "Sign of cross product = " << signOfDet2x2(a, b, c, d) << endl;
}

int main()
{
    make(87869807.75805759429931640625, 97091916, 23759858721.204151153564453125, 26253502380.28125);
